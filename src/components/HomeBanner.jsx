      ...
      <div className='container mx-auto h-full flex flex-col justify-center'>
        <div className='flex items-start justify-center flex-col px-4 md:px-8 max-w-[784px] mb-20'>
          <h1 className="text-white text-6xl mb-10">
            Encuentra a los mejores abogados <span className="italic">especializados</span>
          </h1>
          <div className="w-full max-w-[500px] flex gap-4">
            <Input placeholder="Ejemplo Abogado, Minería, etc." />
            <Button variant="outline" size="icon" className="rounded-full bg-lg_yellow">
        ...
        <Carousel
                  ...
                  <div>
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription className='line-clamp-3'>Listo para proteger tus contratos, gestionar propiedades y planificar herencias familiares</CardDescription>
                      </CardHeader>
                      <CardFooter>
          ...
          <div className='text-white px-4 md:px-8 flex gap-8'>
