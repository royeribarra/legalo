...
export class Migrations1727136189242 implements MigrationInterface {
    name = 'Migrations1727136189242'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`clientes\` ADD CONSTRAINT \`FK_38f14480a2534a5907a2a0e06b4\` FOREIGN KEY (\`ofertaId\`) REFERENCES \`ofertas\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`clientes\` DROP FOREIGN KEY \`FK_38f14480a2534a5907a2a0e06b4\``);
        ...
        await queryRunner.query(`DROP INDEX \`REL_38f14480a2534a5907a2a0e06b\` ON \`clientes\``);
