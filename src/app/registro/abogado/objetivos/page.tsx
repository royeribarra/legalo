...
const CompleteProfileLawyerPage = () => {
  ...
  return (
    <div>
      <div className="container mx-auto p-4 lg:p-8 m-8 lg:w-[740px] mb-[115px]">
      ...
      <div className="grid grid-cols-4 fixed left-0 bottom-0 w-screen h-[115px] bg-[#D5F1F0] z-20">
