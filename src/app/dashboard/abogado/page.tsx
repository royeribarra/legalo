...
const DashboardLawyerPage = () => {
  ...
  useEffect(() => {
    const mediaQuery = window.matchMedia("(min-width: 1024px)"); // Define el breakpoint
    ...
    <div className="px-4 py-4 lg:px-16 lg:py-8">
      ...
      <div className="mt-8">
        <div className="border-b-2 border-[#808080] flex w-full overflow-scroll lg:overflow-auto">
          <Button variant="dashActive" className="">
            Oportunidades para ti
          </Button>
          <Button variant="dashInActive">Publicadas recientemente</Button>
          <Button variant="dashInActive">Invitaciones</Button>
          <Button variant="dashInActive">Guardados</Button>
          <Button variant="dashInActive">Postulaciones</Button>
        </div>
                ...
                >
                  ...
                  <AccordionItem value="item-6">
                    ...
                    <AccordionContent className="flex flex-col gap-2">
                      ...
                      <div className="flex items-center space-x-2 text-base">
                        <Checkbox id="check1" />
                        <label htmlFor="check1">Largo plazo (+ 12 meses)</label>
                      </div>
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
